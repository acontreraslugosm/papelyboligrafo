...
function register_theme_options() {
    add_submenu_page(
            'themes.php', 'Opciones del tema', 'Opciones del tema', 'manage_categories', 'new-theme-options', 'callback_theme_options'
    );
}
...
function callback_theme_options() {
    if (isset($_POST['update'])) {
        ...
        update_option('theme_options_slogan', $slogan);
        ...
        // Display message
        echo '<div id="message" class="updated"><p><strong>Ajustes guardados.</strong></p></div>';
    } else {
        ...
        <form action="" method="post">
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td>
                        <textarea id="slogan" name="slogan" cols="52" rows="5"><?php echo $slogan; ?></textarea>
                    </td>
                    <td>
                    </td>
                    <td>
